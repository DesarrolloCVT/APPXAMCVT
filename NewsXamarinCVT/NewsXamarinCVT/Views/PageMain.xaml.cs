...
namespace NewsXamarinCVT.Views
{
    ...
    public partial class PageMain : MasterDetailPage
    {
        ...
        {
            Detail = new NavigationPage(new MenuPruebaChanta() { Title = "Menú" });
            ...
            options1.Add(new Option { page = new MenuPruebaChanta() { Title = "Menú" }, title = "Inicio", detail = "Inicio" /*image = "ic_ac_home.png" */});
